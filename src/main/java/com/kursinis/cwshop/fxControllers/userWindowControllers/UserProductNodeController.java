...
import com.kursinis.cwshop.model.Cart;
import com.kursinis.cwshop.model.CartItem;
...
public class UserProductNodeController implements Initializable {
    ...
    public void setProductData(Product product) {
        ...
        String imagePath = "/com/kursinis/cwshop/images/" + product.getPhotoName(); // Replace getImageName() with your actual method
