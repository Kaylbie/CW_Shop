...
import com.kursinis.cwshop.fxControllers.createControllers.CreateProductController;
import com.kursinis.cwshop.fxControllers.userWindowControllers.DisplayCustomerProductWindowController;
...
public class ProductNodeController implements Initializable {
    ...
    public void setProductData(Product product, User currentUser) {
        ...
        String imagePath = "/com/kursinis/cwshop/images/" + product.getPhotoName();
